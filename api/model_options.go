...
// Options - <code>Options</code> specify supported <code>methods</code>, <code>Operation.Status</code>, <code>Operation.Type</code>, and all possible transaction submission statuses. This <code>Options</code> object is used by clients to validate the correctness of a Rosetta Server implementation. It is expected that these clients will error if they receive some response that contains any of the above information that is not specified here.
type Options struct {
