...
// Operation - <code>Operations</code> contain all balance-changing information within a transaction. They are always one-sided (only affect 1 <code>AccountIdentifier</code>) and can succeed or fail independently from a <code>Transaction</code>.
