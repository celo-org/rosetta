...
// SubNetworkIdentifier - In blockchains with sharded state, the <code>SubNetworkIdentifier</code> is required to query some object on a specific shard. This identifier is optional for all non-sharded blockchains.
