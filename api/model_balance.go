...
// Balance - <code>Balance</code> is the array of <code>Amount</code> controlled by an <code>AccountIdentifier</code>. An underspecified <code>AccountIdentifier</code> may result in many amounts (ex: all ERC-20 balances for a single address).
type Balance struct {
