...
// Amount - <code>Amount</code> is some <code>Value</code> of a <code>Currency</code>. It is considered invalid to specify a <code>Value</code> without a <code>Currency</code>.
type Amount struct {
